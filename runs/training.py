...
def train(args):
    ...
    TRAIN_LOADER = DataLoader(TRAIN_DATASET, batch_size=1, collate_fn=batch_task_collate, num_workers=10)
    VALID_LOADER = DataLoader(VALID_DATASET, batch_size=1, collate_fn=batch_task_collate, num_workers=5)
    ...
    TEST_LOADER = DataLoader(TEST_DATASET, batch_size=1, shuffle=False, collate_fn=batch_task_collate, num_workers=5)
